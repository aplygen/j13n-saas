package io.j13n.core.commons.base.exception;
...
public class GenericException extends RuntimeException {
    ...
    public GenericExceptionData toExceptionData() {
        ...
        String st =
                Stream.of(this.getStackTrace()).map(StackTraceElement::toString).collect(Collectors.joining("\n"));
        ...
        return new GenericExceptionData()
                .setExceptionId(this.exceptionId)
