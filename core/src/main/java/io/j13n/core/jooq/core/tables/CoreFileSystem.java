...
import io.j13n.core.jooq.public_.enums.CoreFileResourceType;
import io.j13n.core.jooq.public_.enums.CoreFileSystemType;
...
public class CoreFileSystem extends TableImpl<CoreFileSystemRecord> {
     ...
     */
    public final TableField<CoreFileSystemRecord, Long> ID = createField(DSL.name("id"), SQLDataType.BIGINT.nullable(false).defaultValue(DSL.field(DSL.raw("core.core_next_id()"), SQLDataType.BIGINT)), this, "");

    /**
     * The column <code>core.core_file_system.file_resource_type</code>.
     */
    public final TableField<CoreFileSystemRecord, FileResourceType> FILE_RESOURCE_TYPE = createField(DSL.name("file_resource_type"), SQLDataType.VARCHAR.nullable(false).defaultValue(DSL.field(DSL.raw("'STATIC'::core_file_resource_type"), SQLDataType.VARCHAR)).asEnumDataType(CoreFileResourceType.class), this, "", new EnumConverter<CoreFileResourceType, FileResourceType>(CoreFileResourceType.class, FileResourceType.class));
     ...
     */
    public final TableField<CoreFileSystemRecord, FileSystemType> FILE_SYSTEM_TYPE = createField(DSL.name("file_system_type"), SQLDataType.VARCHAR.nullable(false).defaultValue(DSL.field(DSL.raw("'FILE'::core_file_system_type"), SQLDataType.VARCHAR)).asEnumDataType(CoreFileSystemType.class), this, "", new EnumConverter<CoreFileSystemType, FileSystemType>(CoreFileSystemType.class, FileSystemType.class));
