...
public class Indexes {
    ...
    public static final Index IDX1_USER_JOBS_USER_ID = Internal.createIndex(DSL.name("idx1_user_jobs_user_id"), CoreUserJobs.CORE_USER_JOBS, new OrderField[] { CoreUserJobs.CORE_USER_JOBS.USER_ID }, false);
    ...
    public static final Index IDX2_USER_JOBS_JOB_ID = Internal.createIndex(DSL.name("idx2_user_jobs_job_id"), CoreUserJobs.CORE_USER_JOBS, new OrderField[] { CoreUserJobs.CORE_USER_JOBS.JOB_ID }, false);
    ...
    public static final Index IDX3_USER_JOBS_JOB_STATUS = Internal.createIndex(DSL.name("idx3_user_jobs_job_status"), CoreUserJobs.CORE_USER_JOBS, new OrderField[] { CoreUserJobs.CORE_USER_JOBS.JOB_STATUS }, false);
