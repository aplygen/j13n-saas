...
public class Keys {
    ...
    public static final ForeignKey<CoreUserAuthoritiesRecord, CoreAuthoritiesRecord> CORE_USER_AUTHORITIES__CORE_USER_AUTHORITIES_AUTHORITY_ID_FKEY = Internal.createForeignKey(CoreUserAuthorities.CORE_USER_AUTHORITIES, DSL.name("core_user_authorities_authority_id_fkey"), new TableField[] { CoreUserAuthorities.CORE_USER_AUTHORITIES.AUTHORITY_ID }, Keys.CORE_AUTHORITIES_PKEY, new TableField[] { CoreAuthorities.CORE_AUTHORITIES.ID }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<CoreUserAuthoritiesRecord, CoreUsersRecord> CORE_USER_AUTHORITIES__CORE_USER_AUTHORITIES_USER_ID_FKEY = Internal.createForeignKey(CoreUserAuthorities.CORE_USER_AUTHORITIES, DSL.name("core_user_authorities_user_id_fkey"), new TableField[] { CoreUserAuthorities.CORE_USER_AUTHORITIES.USER_ID }, Keys.CORE_USERS_PKEY, new TableField[] { CoreUsers.CORE_USERS.ID }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
}
