...
(
    ...
    USERNAME          CHAR(320) UNIQUE    NOT NULL DEFAULT 'NONE',
...
CREATE TYPE FILE_RESOURCE_TYPE AS ENUM ('STATIC', 'SECURED');
CREATE TYPE FILE_SYSTEM_TYPE AS ENUM ('FILE', 'DIRECTORY');

CREATE TABLE CORE.CORE_FILE_SYSTEM
(
    ID                 BIGINT             NOT NULL DEFAULT CORE.NEXT_ID(),
    FILE_RESOURCE_TYPE FILE_RESOURCE_TYPE NOT NULL DEFAULT 'STATIC',
    CODE               CHAR(8)            NOT NULL,
    NAME               VARCHAR(512)       NOT NULL,
    FILE_SYSTEM_TYPE   FILE_SYSTEM_TYPE   NOT NULL DEFAULT 'FILE',
    SIZE               BIGINT,
    PARENT_ID          BIGINT,
    USER_ID            BIGINT             NOT NULL,
    CREATED_BY         BIGINT,
...
CREATE INDEX IDX_FILE_SYSTEM_CODE_FILE_RESOURCE_TYPE_FILE_SYSTEM_TYPE ON CORE.CORE_FILE_SYSTEM (CODE, FILE_RESOURCE_TYPE, FILE_SYSTEM_TYPE);
CREATE INDEX IDX_FILE_SYSTEM_CODE_NAME ON CORE.CORE_FILE_SYSTEM (CODE, NAME);
