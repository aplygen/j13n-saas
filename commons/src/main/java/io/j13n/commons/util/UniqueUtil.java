...
public class UniqueUtil {
    ...
    public static String shortUUID() {
        ...
        while (num.compareTo(BigInteger.ZERO) != 0) {
            sb.append(BASE.charAt(num.mod(baseDivisor).intValue()));
            num = num.divide(baseDivisor);
        }

        return String.format("%22s", sb.reverse()).replace(' ', '0');
    }
    ...
    public static String uniqueName(int maxLength, String... name) { // NOSONAR
        ...
        return sb.append(base36UUID()).toString();
    }
